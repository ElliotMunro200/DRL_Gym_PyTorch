...
def get_args():
    ...
    parser.add_argument('-ust', '--update_s_term', action='store_true', default=False, help='enables updating of Q(s_terminal,a)')
    ...
    parser.add_argument('-w', '--wandb', action='store_true', default=False, help='enables WandB experiment tracking')
