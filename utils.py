...
def get_args():
    ...
    parser.add_argument('-mes', '--max_ep_steps', type=int, default=200, help='# of total training steps (default: 10000)')
    ...
    parser.add_argument('-up', '--update_period', type=int, default=50, help='# of steps per update (default: 10)')
    parser.add_argument('-bs', '--batch_size', type=int, default=100, help='# batch_size (default: 50)')
    parser.add_argument('--delayed_update_period', type=int, default=2, help='# of critic updates per target+policy updates (default: 2)')
    parser.add_argument('-wp', '--warmup_period', type=int, default=1000, help='# timestep to start training on')
    ...
    parser.add_argument('-clr', '--critic_learning_rate', type=float, default=1e-3, help='clr value (default: 1e-3)')
    parser.add_argument('--act_noise', type=float, default=0.1, help='noise added to actions (default: 0.1)')
